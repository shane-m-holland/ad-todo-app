...
export function TodoList() {
  ...
  if (isLoading) {
    return (
      <div className="w-full max-w-2xl mx-auto">
        <div className="bg-white rounded-lg border-2 border-gray-200 p-8 text-center shadow-sm">
  ...
  if (error) {
    return (
      <div className="w-full max-w-2xl mx-auto">
        <div className="bg-red-50 rounded-lg border-2 border-red-200 p-8 text-center shadow-sm">
          <svg
  ...
  if (!todos || todos.length === 0) {
    return (
      <div className="w-full max-w-2xl mx-auto">
        <div className="bg-gray-50 rounded-lg border-2 border-gray-200 p-8 text-center shadow-sm">
          <svg
      ...
      <div className="bg-white rounded-lg border-2 border-gray-200 p-4 shadow-sm">
        <div className="flex justify-between items-center text-sm">
          <span className="text-gray-600">
            Total: <strong className="text-gray-900">{todos.length}</strong>
          </span>
          <span className="text-gray-600">
            Active:{" "}
          ...
          <span className="text-gray-600">
            Completed:{" "}
            <strong className="text-green-600">{completedTodos.length}</strong>
          </span>
        </div>
      </div>
